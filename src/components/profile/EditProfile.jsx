...
import { FaUser, FaEnvelope, FaMapMarkerAlt, FaCamera, FaSave, FaTimes, FaPlus } from 'react-icons/fa';
...
export const EditProfile = ({ userData, onSave, onCancel }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await updateUserProfile(userData.userId, formData);
